...
export default async function mockFetch(url: FetchParams[0]) {
  switch (url) {
    case "https://fakestoreapi.com/products/categories": {
      return {
        ok: true,
        status: 200,
        json: async () => categoriesListResponse,
      };
    }
    case "https://fakestoreapi.com/products": {
      return {
        ok: true,
        status: 200,
        json: async () => productsListResponse,
      };
    }
    case "https://fakestoreapi.com/auth/login": {
      return {
        ok: true,
        status: 200,
